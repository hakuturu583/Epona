...
_NUSCENES_META = os.path.join(_REPO_ROOT, "meta_data_nusc")

datasets_paths = dict(
    nuscense_root=_NUSCENES_ROOT,
    nuscense_train_json_path=os.path.join(_NUSCENES_META, "nuscenes_train.json"),
    nuscense_val_json_path=os.path.join(_NUSCENES_META, "nuscenes_val.json"),
    nuplan_root="",
    nuplan_json_root="",
)
