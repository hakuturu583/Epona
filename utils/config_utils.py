...
def _is_builtin_module(module_name: str) -> bool:
    ...
    if (
        ...
        or not origin_path.startswith((PYTHON_ROOT_DIR, "/usr/lib/python"))
    ):
        return False
    else:
        return True
        ...
        try:
            with tempfile.TemporaryDirectory() as temp_config_dir:
                ...
                if filename.endswith(".py"):
                    ...
                    # config.
                    global_locals_var = {BASE_KEY: base_cfg_dict, "__file__": filename}
    ...
    def _parse_lazy_import(filename: str) -> Tuple[ConfigDict, set]:
        ...
        with open(filename, encoding="utf-8") as f:
            ...
            for base_module in base_modules:
                ...
                (
                    _base_cfg_dict,
                    _base_imported_names,
                ) = Config._parse_lazy_import(  # noqa: E501
                    module_path
                )
...
if __name__ == "__main__":
    cfg = Config.fromfile(
        "/home/users/tianyu.gu/codes/projs_debug/socket/socketv2/socket/configs/mar/baseline_diffloss.py"
    )
